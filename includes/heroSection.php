      ...
      <!-- ========================= hero-2 start ========================= -->
        <div class="videoBanner hero-section position-relative d-flex overflow-hidden justify-content-center">
          <video class="d-md-block d-none" autoplay muted loop id="myVideo">
            <source src="assets/video/nut.mp4" type="video/mp4">
          </video>
          <video class="d-md-none" autoplay muted loop id="myVideo">
            <source src="assets/video/nut_mob.mp4" type="video/mp4">
          </video>
